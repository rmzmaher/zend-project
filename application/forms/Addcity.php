...
class Application_Form_Addcity extends Zend_Form
{
    ...
    public function init()
    {
        $this->setMethod('POST');
     	...
     	$atitude= new Zend_Form_Element_Text('atitude');
     	$atitude->setLabel('Atitude:');
     	$atitude->setAttribs(array('placeholder'=>'atitude','class'=>'form-control'));
    ...
    $image->setAttribs(array('class'=>'form-control'));
	...
	$image->addValidator('Count', false, 1);
       ...
       $image->addValidator('Extension',false, 'jpg,jpeg,png,gif');
     	...
     	$this->addElements(array($id,$name,$atitude,$latitude,$image,$rating,$description,$submit,$reset));
